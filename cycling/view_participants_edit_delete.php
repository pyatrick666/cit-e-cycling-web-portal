...
<div class="d-flex justify-content-between align-items-center mb-4"><div><h1 class="h2 mb-1">View all participants for edit or delete</h1><p class="text-muted mb-0">Select an action for a participant record.</p></div><div><a href="admin_menu.php" class="btn btn-outline-secondary me-2">Admin menu</a><a href="logout.php" class="btn btn-outline-danger">Logout</a></div></div>
<?php
...
try {
    ...
    if (!$rows) {
        ...
        echo '<div class="card shadow-sm"><div class="card-body"><div class="table-responsive"><table class="table table-striped align-middle"><thead><tr><th>ID</th><th>Name</th><th>Email</th><th>Power output</th><th>Distance</th><th>Club</th><th>Actions</th></tr></thead><tbody>';
        foreach ($rows as $r) {
            echo '<tr>';
