...
if ($usernameInput === '' || $passwordInput === '') {
    echo '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><title>Login</title></head><body class="bg-light"><div class="container py-5"><div class="alert alert-danger">Username and password are required.</div><a class="btn btn-primary" href="admin_login.html">Back to login</a></div></body></html>';
    exit;
}
try {
...
echo '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><title>Login</title></head><body class="bg-light"><div class="container py-5"><div class="alert alert-danger">Incorrect username or password.</div><a class="btn btn-primary" href="admin_login.html">Back to login</a></div></body></html>';
?>
