...
<div class="d-flex justify-content-between align-items-center mb-4"><h1 class="h2 mb-0">Update participant score</h1><div><a href="view_participants_edit_delete.php" class="btn btn-outline-secondary me-2">Back</a><a href="logout.php" class="btn btn-outline-danger">Logout</a></div></div>
